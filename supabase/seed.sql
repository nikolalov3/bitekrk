...
insert into venues (slug, name, district, address, price_range, tags) values
  ...
  ('tociekawa',        'Tociekawa Specialty Coffee', 'Kleparz',    'ul. Długa 37, Kraków',               '$$', '{"specialty coffee","laptop friendly"}'),
  ...
  ('aura-kleparz',     'Aura Cafe',                  'Kleparz',    'Stary Kleparz, Rynek Kleparski, Kraków', '$', '{"espresso bar","market"}'),
...
from (values
  ...
  ('where-to-work-krakow', 'tociekawa', 2),
  ...
  ('kleparz-guide', 'tociekawa', 2),
  ('kleparz-guide', 'fornir', 3),
  ('kleparz-guide', 'aura-kleparz', 4),
